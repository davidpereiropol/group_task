...
ggplot(winners_by_party, aes(x = date, y = num_municipalities, color = party_recoded)) +
  # Fondo coloreado para el partido ganador de elecciones generales
  geom_rect(data = general_election_winners,
            aes(xmin = date, xmax = end_date, ymin = -Inf, ymax = Inf, fill = party_recoded),
            alpha = 0.1, inherit.aes = FALSE) +
  # Líneas de evolución de los municipios ganados
  geom_line(size = 1) +
  geom_point(size = 3) +  # Puntos con borde negro
  ...
  # Colores del fondo para el partido ganador
  scale_fill_manual(
    values = c(
      "PARTIDO POPULAR" = "#1db4e8",
      "PARTIDO SOCIALISTA OBRERO ESPAÑOL" = "#c30505"
  ...
  # Añadir líneas verticales en las fechas de elección
  geom_vline(data = general_election_winners, aes(xintercept = as.numeric(date)),
             color = "gray50", linetype = "dashed", size = 0.6) +
  labs(
...
ggplot(second_combined, aes(
  ...
  geom_stratum(width = 1/6, fill = "lightgray", color = "black") +
